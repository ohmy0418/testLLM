...
function getDrawCurvedEdgeLabel(_ref) {
  ...
  return function (context, edgeData, sourceData, targetData, settings) {
    ...
    var sourceX = sourceData.x;
    var sourceY = sourceData.y;
    var targetX = targetData.x;
    var targetY = targetData.y;
    ...
    // Anchor point:
    var anchorX = centerX + diffY * curvature;
    var anchorY = centerY - diffX * curvature;
...
function createEdgeCurveProgram(inputOptions) {
  ...
  var UNIFORMS = ["u_matrix", "u_sizeRatio", "u_dimensions", "u_pixelRatio"].concat(_toConsumableArray(arrowHead ? ["u_lengthToThicknessRatio", "u_widenessToThicknessRatio"] : []));
